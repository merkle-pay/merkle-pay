...
**Solana、Base、SUI、TRON、Polygon、Arbitrum、Optimism などでステーブルコイン決済を簡単に受け入れ—クリエイター、インディーハッカー、スモールビジネス向けに構築。**
...
- **基本 UI**: クリーンで機能的なインターフェースのために Arco Design を利用しています。(現在は機能性に重点を置いており、UI への貢献を歓迎します!)
